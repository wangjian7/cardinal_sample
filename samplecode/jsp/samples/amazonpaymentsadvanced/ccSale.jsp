...
<tr>
	<td>OrderNumber </td><td><input type=text name="order_number" value=""></td>
</tr>
<tr>
	<td>Description </td><td><input type=text name="description" value="Sale Description"></td>
</tr>
<tr>
	<td>MerchantData </td>
...
<tr>
  <td></td>
  <td><input type=submit name="submit" value="Process Sale"></td>
</tr>
<tr>
...
<b> Sale Transaction Request Results </b>
<table>
<tr>
