...
<%
	...
	String CENTINEL_TERM_URL, MODAL_URL, BROADCASTRESIZE_URL, WIDGET_URL, DEBUGOUTPUT;
	...
	CENTINEL_TERM_URL	= "http://yoursite.com/securecodeplus/ccAuthenticate.jsp";
	MODAL_URL       	= "http://yoursite.com/securecodeplus/ccNotify.jsp";
 	BROADCASTRESIZE_URL 	= "https://stagingeacs.cardinalcommerce.com/ecdc/js/broadcastResize.js";
    	WIDGET_URL    		= "https://stagingeacs.cardinalcommerce.com/ecdc/widgetv2.asp";
    	DEBUGOUTPUT     	= "false";
