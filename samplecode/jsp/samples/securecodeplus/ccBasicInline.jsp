	...
	<head>
		...
		<script type="text/javascript">
			...
			function runCentinelClient(termUrl, modalUrl, generatePayloadUrl, timeout ) {
				...
				client.Debug = false;																// Print debug statements - Default: false
				client.ConsolePrint = false;														// Print debug statements in the browsers console instead of in alert boxes - Default: false
				try {
					/*
					///////////////////// [ URL DEFINITIONS ] ////////////////////////
					This loads all of the config URL's into the Centinel Widget,
					...
					*/
					...
					client.ModalWindow = "renderAuthScreen";
					// Data you'd like echoed back to the TermUrl.
					client.MerchantData = "A String of Merchant Data";
					 
					/*
					///////////////////// [ ANIMATION HOOKS ] ////////////////////////
					Animation Hooks let you execute code before or after certain events. This allows for any kind of setup or
					clean up actions that may be needed to deal with different kind of events. Examples: If the merchant
					site would like to integrate a INLINE integration method where the Authentication screen is not
					shown until it is loaded. They may want to control the loading Icon themselves and display it in
					a completely different position then where the Authentication screen will appear. In this case the
					use of BeforeRenderSetup - to display it loading icon - and BeforeResize to destroy the icon may be used.
					*/
					client.BeforeRenderSetup = "CustomBeforeRenderSetup()";
					/*
					///////////////////// [ INLINE CONFIGURATIONS ] ////////////////////////
					Specific Configurations only to the inline style
					*/
					 
					client.ExtraContentId = "";
					client.PlaceHolderDivId = "renderAuthScreen";
					client.LoadBeforeResize = false;
					/*
					///////////////////// [ ERROR HANDLERS ] ////////////////////////
					Javascript handlers for different errors that can occur. It is STRONGLY recommended that these be used.
					*/
					client.LookupErrorHandler = "LookupErrorHandler()";
					client.AjaxErrorHandler = "AjaxErrorHandler()";
					client.PromptActionCodeHandler = "PromptActionCodeHandler()";
			...
			function CustomBeforeRenderSetup(){			
				$("#renderAuthScreen").css({'border':'6px solid black','padding':'7px', 'border-radius':'10px'});
			}
...
<%@ include file="ccMenu.jsp" %>
		...
		<input type="hidden" name="javascript_support" value="False" />
			...
			<table>
				...
				<tr>
					<td colspan="4"><div id="renderAuthScreen" style="position:relative;" ></div></td>
				</tr>
				<tr>
