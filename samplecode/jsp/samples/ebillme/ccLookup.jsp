...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	centinelRequest.add("Item_Category_1", request.getParameter("item_category_1"));
	...
	//centinelRequest.add("Item_Category_2", request.getParameter("item_category_2"));
	//centinelRequest.add("Item_ShipAmount_2", request.getParameter("item_shipamount_2"));

	// -- Payment Type Specific --'
	centinelRequest.add("CustomerRating", request.getParameter("customer_rating"));
	centinelRequest.add("CustomerFlag", request.getParameter("customer_flag"));
	...
	centinelRequest.add("ShippingCompanyName", request.getParameter("shipping_company_name"));
