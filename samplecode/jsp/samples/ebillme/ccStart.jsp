...
<script type="text/javascript">
	 window.onload = function() {
			...
			document.frm.amount.value = parseInt(document.frm.item_price_1.value);
...
<tr>
	<td bgcolor="ffff40">Customer Rating</td>
	<td>
		<select name="customer_rating" id="customer_rating" style="width:125px">
			<option value="1">1 - Existing good user</option>
			<option value="2">2 - Existing bad user</option>
			<option value="3">3 - Unknown</option>
		</select>
	</td>
	<td>Customer Flag</td>
	<td>
		<select name="customer_flag" id="customer_flag" style="width:125px">
...
<tr>
	...
	<td bgcolor="ffff40">Shipping Method</td>
	<td>
...
<tr>
	<td>Shipping Company Name</td><td><input type=text name="shipping_company_name" value=""></td>
	<td>Tracking Number</td><td><input type=text name="tracking_number" value=""></td>
</tr>
<tr>
	<td>&nbsp;</td><td></td>
	<td>&nbsp;</td><td></td>
...
<tr>
	...
	<td bgcolor="ffff40">Buyer Alt Email</td><td><input type="text" name="email_address_alt" value="johnconsumer@consumerdomain.com"></td>
</tr>
<tr>
	<td>&nbsp;</td><td></td>
	<td>&nbsp;</td><td></td>
...
<tr>
	<td>Item 1 Category</td><td><input type="text" name="item_category_1" value=""/></td>
	<td>Item 2 Category</td><td><input type="text" name="item_category_2" value=""/></td>
</tr>
<tr>
	<td>Item 1 Ship Amount</td><td><input type="text" name="item_shipamount_1" value=""/></td>
