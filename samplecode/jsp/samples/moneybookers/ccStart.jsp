...
<tr>
	...
	<select name="txn_type">
		 <option value="MB">MB - Moneybookers</option>
	</select></td>
	<td></td><td></td>
</tr>
<tr>
...
<tr>
	...
	<td>Recurring Grace Period</td><td><input type="text" name="recurring_grace_period" value=""></td>
</tr>
<tr>
...
<tr>
	...
	<td>Recurring Cycle</td><td><select name="recurring_cycle">
										<option value=""></option>
...
<tr>
	<td>Recurring Max Amount</td><td><input type=text name="recurring_max_amount" value=""></td>
	<td>Merchant Consumer Message</td><td><input type=text name="merchant_consumer_message" value="">
