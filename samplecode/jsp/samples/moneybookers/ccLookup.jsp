...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	centinelRequest.add("RecurringAmount", request.getParameter("recurring_amount"));
	centinelRequest.add("RecurringStart", request.getParameter("recurring_start"));
	...
	centinelRequest.add("RecurringCycle", request.getParameter("recurring_cycle"));
	centinelRequest.add("RecurringGracePeriod", request.getParameter("recurring_grace_period"));
	centinelRequest.add("RecurringMaxAmount", request.getParameter("recurring_max_amount"));
	centinelRequest.add("MerchantConsumerMessage", request.getParameter("merchant_consumer_message"));
	
	//centinelRequest.add("OverrideUserLanguage", "EN");
	//centinelRequest.add("OverrideHeaderImage", "http://www.yourimageurl.com");
