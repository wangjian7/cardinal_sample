...
<tr>
	...
	<select name=txn_type>
		 <option value="SP">SP - SafetyPay</option>
	</select></td>
</tr>
<tr>
...
<tr>
	<td bgcolor="ffff40">Carrier </td><td><input type=text size="60" name="carrier" value=""></td>
</tr>
<tr>
...
<tr>
  <td></td>
  <td><input type=submit name="submit" value="Process Add Order Tracking"></td>
</tr>
<tr>
