...
%>
<%
	String MESSAGE_VERSION, TRANSACTION_URL, MERCHANT_ID, PROCESSOR_ID, CENTINEL_TERM_URL,CENTINEL_LOOKUP_URL, TRANSACTION_PWD;
	...
	CENTINEL_LOOKUP_URL	= "http://yoursite.com/googlewallet/ajaxProxy.jsp";		
	CENTINEL_TERM_URL = "http://yoursite.com/googlewallet/ccAuthenticate.jsp";
