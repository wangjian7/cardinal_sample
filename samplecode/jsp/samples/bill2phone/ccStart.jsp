...
<form name="frm" method=post action="ccLookup.jsp">
    <table>
		...
		<td>Test Case</td>
		<td>
			<select name="testCase" onChange="setTestCaseData(document.forms[0].testCase.options[document.forms[0].testCase.selectedIndex].value);">
				<option value=""></option>
				<option value="1">Test Case 1 Carissa Pycroft 0649</option>
				<option value="2">Test Case 2 Derren Jerome 8996</option>
				<option value="3">Test Case 3 Jerrod Buzzard 0342</option>
				<option value="4">Test Case 4 Gage Heyman 1758</option>
				<option value="5">Test Case 5 Calvin Rawls 2281</option>
			</select>
		</td>
		</tr>
	<tr>
	...
	<tr>
		<td width="150">Recurring Amount</td><td><input type="text" name="recurring_amount" value=""></td>
		
	</tr>
	
	<tr>
		<td>Recurring Start</td><td><input type="text" name="recurring_start" value=""></td>
		<td>Recurring End</td><td><input type="text" name="recurring_end" value=""></td>
	</tr>
	
	<tr>
	
		<td>Recurring Cycle</td><td><select name="recurring_cycle" onchange="setRecurring()">
											<option value=""></option>
