...
%>
<%
	String MESSAGE_VERSION, TRANSACTION_URL, MERCHANT_ID, PROCESSOR_ID, CENTINEL_TERM_URL, DEMO_TERM_URL, TRANSACTION_PWD;
	String AUTHENTICATION_MESSAGING, MERCHANT_LOGO, VBV_LOGO, MCSC_LOGO, JCB_LOGO, SEB_LOGO, BML_LOGO;
	...
	CENTINEL_TERM_URL	= "http://yoursite.com/processormodule/ccAuthenticate.jsp";
