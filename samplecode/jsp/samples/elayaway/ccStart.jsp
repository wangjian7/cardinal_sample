...
<script type="text/javascript">
	 window.onload = function() {
			...
			document.frm.amount.value = parseInt(document.frm.item_price_1.value)+parseInt(document.frm.item_tax_1.value)+parseInt(document.frm.item_shipping_1.value);
...
<tr>
	...
	<select name="txn_type">
		  <option value="EL">EL - eLayaway Payments
	</select></td>
	<td></td><td></td>
</tr>
<tr>
...
<tr>
	<td bgcolor="ffff40">Item 1 Tax</td><td><input type="text" name="item_tax_1" value="100"/></td>
	<td>Item 2 Tax</td><td><input type="text" name="item_tax_2" value=""/></td>
</tr>
<tr>
	<td>Item 1 Duration</td><td><input type="text" name="item_duration_1" value=""/></td>
	<td>Item 2 Duration</td><td><input type="text" name="item_duration_2" value=""/></td>
</tr>
<tr>
	<td bgcolor="ffff40">Item 1 Shipping</td><td><input type="text" name="item_shipping_1" value="200"/></td>
	<td>Item 2 Shipping</td><td><input type="text" name="item_shipping_2" value=""/></td>
</tr>
<tr>
	<td>&nbsp;</td><td></td>
	<td>&nbsp;</td><td></td>
