...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	centinelRequest.add("Item_Tax_1", request.getParameter("item_tax_1"));
	centinelRequest.add("Item_Duration_1", request.getParameter("item_duration_1"));
	centinelRequest.add("Item_Shipping_1", request.getParameter("item_shipping_1"));
	...
	centinelRequest.add("Item_Tax_2", request.getParameter("item_tax_2"));
	centinelRequest.add("Item_Duration_2", request.getParameter("item_duration_2"));
	centinelRequest.add("Item_Shipping_2", request.getParameter("item_shipping_2"));
