...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	centinelRequest.add("MDN", request.getParameter("mdn"));
...
//////////////////////////////////////////////////////////////////////////////////////////
	...
	if ("0".equals(strErrorNo) && "Y".equalsIgnoreCase(strCardEnrolled)) { 
		...
		if ("WAP".equals(request.getParameter("order_channel")) && !"".equals(strACSUrl)) {
			String redirectURL = strACSUrl + "?requestToken=" + strOrderId + "&purchaseType=" + request.getParameter("purchase_type") + "&TermUrl=" + CENTINEL_TERM_URL;
			response.sendRedirect(redirectURL);
		} else {
			response.sendRedirect("ccResults.jsp");
		}
