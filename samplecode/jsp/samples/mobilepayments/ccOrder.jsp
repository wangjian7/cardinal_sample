...
<tr>
	<td>ShippingAmount </td><td><input type=text name="shipping_amount" value=""></td>
</tr>
<tr>
	<td>TaxAmount </td><td><input type=text name="tax_amount" value=""></td>
</tr>
<tr>
...
if ("true".equals(executeTransaction)){
	...
	<br/><br/>
	<b> Order Transaction Response </b>
	<table>
	<tr>
