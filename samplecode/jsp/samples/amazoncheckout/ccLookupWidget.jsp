...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	centinelRequest.add("TermUrl", CENTINEL_TERM_URL);
	centinelRequest.add("MD", "");
...
({
    ...
    "Enrolled": "<%=centinelResponse.getValue("Payload")%>",
    ...
    "OrderId": "<%=centinelResponse.getValue("OrderId")%>",
    "AmazonOrder": "<%=centinelResponse.getValue("PostField")%>",
    "AmazonOrder2": "<%=centinelResponse.getValue("PostField2")%>"
