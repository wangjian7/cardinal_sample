...
<tr>
	<td>Description </td><td><input type=text name="description" value="Refund Description"></td>
</tr>
<tr>
...
<tr>
	<td>Item 1 SKU </td>
	<td><input type="text" name="item_sku_1" value=""></td>
</tr>
<tr>
	<td>Item 1 Amount </td>
	<td><input type="text" name="item_amount_1" value=""></td>
</tr>
<tr>
	<td>Item 1 Quantity </td>
	<td><input type="text" name="item_quantity_1" value=""></td>
</tr>
<tr>
  <td></td>
