...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	if (pares != null && pares.length() > 0) {
		...
		session.setAttribute("Centinel_ReasonCode", centinelResponse.getValue("ReasonCode"));
		session.setAttribute("Centinel_ReasonDesc", centinelResponse.getValue("ReasonDesc"));
		session.setAttribute("Centinel_ProcessorOrderNumber", centinelResponse.getValue("ProcessorOrderNumber"));
