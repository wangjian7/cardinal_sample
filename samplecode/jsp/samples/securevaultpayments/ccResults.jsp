...
session.removeAttribute("Centinel_ProcessorTransactionId");
session.removeAttribute("Centinel_Amount");
session.removeAttribute("Centinel_AuthorizationCode");
session.removeAttribute("Centinel_PayDate");
session.removeAttribute("Centinel_PayTime");
