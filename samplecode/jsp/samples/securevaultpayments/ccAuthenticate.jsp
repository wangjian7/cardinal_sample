...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	if (pares != null && pares.length() > 0) {
		...
		session.setAttribute("Centinel_AuthorizationCode", centinelResponse.getValue("AuthorizationCode"));
		session.setAttribute("Centinel_PayDate", centinelResponse.getValue("PayDate"));
		session.setAttribute("Centinel_PayTime", centinelResponse.getValue("PayTime"));
		session.setAttribute("Centinel_ProcessorTransactionId", centinelResponse.getValue("ProcessorTransactionId"));
		session.setAttribute("Centinel_Amount", centinelResponse.getValue("Amount"));
	...
	String errorDesc = (String) session.getAttribute("Centinel_ErrorDesc");
