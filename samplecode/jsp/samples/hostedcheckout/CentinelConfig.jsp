...
%>
<%
	String MESSAGE_VERSION, TRANSACTION_URL, MERCHANT_ID, PROCESSOR_ID, CENTINEL_TERM_URL, TRANSACTION_PWD, CENTINEL_MERCHANT_LOGO, CENTINEL_CONSUMER_MESSAGE;
	...
	CENTINEL_TERM_URL = "http://yoursite.com/hostedcheckout/ccAuthenticate.jsp";
	
	CENTINEL_MERCHANT_LOGO = "../../images/merchant_logo.gif";
	CENTINEL_CONSUMER_MESSAGE = "<b>For your security, please fill out the form below to complete your order.</b>" +
                             "<br/>Do not click the refresh or back button or this transaction may be interrupted or cancelled.";
