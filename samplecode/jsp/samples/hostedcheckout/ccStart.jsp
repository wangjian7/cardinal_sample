...
<tr>
	...
	<td>
                <select name="txn_type">
                    <option value="HC">HC - HostedCheckout</option>
                </select>
	</td>
	<td>Force Transaction Type</td>
	<td>
                <select name="force_txn_type">
			<option value=""></option>
                        <option value="PP">PP - PayPal</option>
			<option value="CC">CC - ProcessorModule</option>
                </select>
	</td>
</tr>
		<tr>
...
<tr>
    <td style="color:white;background-color:green" colspan=4><b>PayPal</b></td><td></td>
    
</tr>
<tr>
	<td>No Shipping</td>
	<td><select name="no_shipping">
		  <option value=""></option>
...
<tr>
    <td style="color:white;background-color:green" colspan=4><b>CreditCards (processor module)</b></td><td></td>
...
<tr>
 <td width="150">CardCode</td><td><input type="text" name="card_code" value=""></td>
...
<tr>
    <td style="color:white;background-color:green" colspan=4><b>Generic</b></td><td></td>
...
<tr>
	...
	<td>CustomData </td><td><input type="text" name="custom_data" value=""></td>
</tr>
<tr>
	<td>&nbsp;</td><td></td>
	<td>&nbsp;</td><td></td>
