...
<form name="frm" method=post action="ccLookup.jsp">
    <table>
		...
		<td>&nbsp;</td><td></td>
				...
				<tr>
					<td bgcolor="ffff40" width="150">Customer Id</td><td><input type="text" name="customerId" value=""></td>
					<td>&nbsp;</td><td></td>
				</tr>					
				<tr>
					...
					<td>
                        <select name="select_card">
							<option value=""></option>
							<option value="cvspharmacy">CVS/pharmacy</option>
        ...
        <tr>
    		...
    		<td><input type="text" name="category_code" /></td>
				...
				<tr>
					...
					<td>Rating Model</td>
					<td><input type="text" name="rating_model" value=""></td>
				</tr>
				
				<tr>
					<td>Product Rating</td>
					<td><input type="text" name="product_rating" value=""></td>
					<td>Sub-Property Id</td>
					<td><input type="text" name="subproperty_id" value=""></td>
				</tr>
				
				<tr>
					<td>Sub-Property Name</td>
					<td><input type="text" name="subproperty_name" value=""></td>
					<td>Sub-Property Url</td>
					<td><input type="text" name="subproperty_url" value=""></td>
				</tr>
				
				<tr>
					<td>Product Id</td>
					<td><input type="text" name="product_id" value=""></td>
					<td>MerchantData </td><td>
					<input type="text" name="merchant_data" value=""></td>
         <td>&nbsp;</td><td></td>
				</tr>        
