...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	// Payment Type Specific Values
	
	centinelRequest.add("SelectCard", request.getParameter("select_card"));
	centinelRequest.add("CustomerId", request.getParameter("customer_id"));
	centinelRequest.add("ProductId", request.getParameter("product_id"));
	centinelRequest.add("RatingModel", request.getParameter("rating_model"));
	centinelRequest.add("ProductRating", request.getParameter("product_rating"));
	centinelRequest.add("SubPropertyId", request.getParameter("subproperty_id"));
	centinelRequest.add("SubPropertyName", request.getParameter("subproperty_name"));
	centinelRequest.add("SubPropertyUrl", request.getParameter("subproperty_url"));
