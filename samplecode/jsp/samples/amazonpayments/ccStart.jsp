...
<tr>
	...
	<select name="txn_type">
		  <option value="AP">AP - Amazon Payments</option>
	</select></td>
	<td></td><td></td>
</tr>
<tr>
...
<tr>
	<td width="150">TokenType</td>
	<td>
		<select name="token_type" style="width:125px">
				<option value=""></option>
				<option value="single">single</option>
				<option value="multi">multi</option>
			</select>
	</td>
	<td>TokenLength</td><td><input type=text name="token_length" value=""></td>
</tr>
<tr>
	<td>TransactionAction</td>
	<td><select name="transaction_action"  style="width:125px">
		  <option value=""/>
		  <option value="Authorization">Authorization
