...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	centinelRequest.add("TransactionAction", request.getParameter("transaction_action"));
	centinelRequest.add("TokenType", request.getParameter("token_type"));
	centinelRequest.add("TokenLength", request.getParameter("token_length"));
...
//////////////////////////////////////////////////////////////////////////////////////////
	...
	session.setAttribute("Centinel_ACSURL", centinelResponse.getValue("ACSUrl"));
	session.setAttribute("Centinel_PAYLOAD", centinelResponse.getValue("Payload"));
