...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	centinelRequest.add("OverrideFeeType", request.getParameter("override_feeType"));
...
//////////////////////////////////////////////////////////////////////////////////////////
	...
	if ("0".equals(strErrorNo) && "Y".equalsIgnoreCase(strCardEnrolled)) { 
		...
		session.setAttribute("Message", "Payment is unavailable. Please provide another form of payment to complete your transaction." + " " + strErrorDesc);
		response.sendRedirect("ccStart.jsp");

	} else {	
		// An error was encountered Log Error Message, this is an unexpected state --->
		session.setAttribute("Message", "Payment was unable to complete. Please provide another form of payment to complete your transaction." + " " + strErrorDesc);
		response.sendRedirect("ccStart.jsp");
