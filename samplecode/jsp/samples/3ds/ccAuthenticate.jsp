...
/////////////////////////////////////////////////////////////////////////////////////////
    ...
    String redirectPage = "ccOrderComplete.jsp";
	...
	if (("0".equals(errorNo) || "1140".equals(errorNo)) && "Y".equals(sigVerStatus) && ("Y".equals(paresStatus) || "A".equals(paresStatus))) {
		...
		session.setAttribute("Centinel_Message", "Your transaction completed successfully.");
		redirectPage = "ccOrderComplete.jsp";
		...
		session.setAttribute("Centinel_Message", "Your transaction was unable to authenticate. Please provide another form of payment. (PAResStatus = N)");
		redirectPage = "ccOrderComplete.jsp";
		...
		session.setAttribute("Centinel_Message", "Your transaction completed however is pending review. Your order will be shipped once payment is verified.");
		redirectPage = "ccOrderComplete.jsp";
