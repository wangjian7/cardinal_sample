...
//=====================================================================================
//==============================[ Integration Step ]============================================
// Integration Document Step 4 - Send a cmpi_lookup request to Centinel
//=====================================================================================	
...
//////////////////////////////////////////////////////////////////////////////////////////
	...
	String strWidgetPayload = centinelResponse.getValue("WidgetPayload");
	...
	session.setAttribute("Centinel_WidgetPayload",centinelResponse.getValue("WidgetPayload"));
...
//=====================================================================================
//==============================[ Integration Step ]============================================
// Integration Document Step 5 - Return the lookup results as JSON
//=====================================================================================
%>	

<%response.setContentType("application/x-javascript; charset=utf-8");%>

<%=(String) session.getAttribute("Centinel_WidgetPayload")%>
