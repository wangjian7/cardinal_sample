...
<tr>
	...
	<select name="txn_type">
		  <option value="ME">ME - MyECheck</option>
	</select></td>
	<td></td><td></td>
<tr>
	<td>&nbsp;</td><td></td>
...
<tr>
	<td>Bank Name </td><td><input type=text name="bank_name" value=""></td>
	<td>Account Type</td><td><input type=text name="account_type" value=""></td>
</tr>
<tr>
	<td>Routing Number </td><td><input type=text name="routing_number" value=""></td>
	<td>Account Number </td><td><input type=text name="account_number" value=""></td>
</tr>
<tr>
	<td>&nbsp;</td><td></td>
	<td>&nbsp;</td><td></td>
