...
//	ccBMLNotification.jsp
//
//	This page receives Bill Me Later payment update notifications from Centinel via
//	HTTP posts and queries Centinel for the Bill Me Later payment status update.
//
...
<%
	...
	if (notificationId.length() > 1) {
		...
		// Log 'MISSING PARAMETER notification_id' to your webserver
	}
