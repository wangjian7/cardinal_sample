...
<%
	...
	String BILLMELATER_MESSAGING, MERCHANT_LOGO, BML_LOGO;
	...
	CENTINEL_TERM_URL = "http://yoursite.com/bml/ccAuthenticate.jsp";

	// Check with Cardinal to determine appropriate Timeout period for this payment type.
	TIMEOUT_READ     = 35000;
	TIMEOUT_CONNECT  = 10000;

	BILLMELATER_MESSAGING = "<b>Please complete the Bill Me Later<sup>&reg;</sup> Account Application form below to complete your order.</b><br/>Do not click the refresh or back button or this transaction may be interrupted or cancelled.";
	MERCHANT_LOGO = "../../images/merchant_logo.gif";
	BML_LOGO = "../../images/logo_bml_frame.JPG";
