...
<br/>
<b>Preapproval Request Form</b>
<form name="frm" method="POST" action="ccPreapproval.jsp?execute=true">
<table>
<tr>
	...
	<td>Test Case</td>
		<td><select name="testCase" onChange="setTestCaseData(document.forms[0].testCase.options[document.forms[0].testCase.selectedIndex].value);" style="width:125px">
					<option value="">
					<option value="32">Test Case 32</option>
					<option value="33">Test Case 33</option>
					<option value="34">Test Case 34</option>
			</select>
		</td>
</tr>
<tr>
...
<tr>
	<td bgcolor="ffff40">Promo Code</td><td><input type=text name="promo_code" value="PreApproval"></td>
...
if ("true".equals(executeTransaction)){
	...
	centinelRequest.add("MsgType", "cmpi_preapproval");
	...
	*/
	...
	String strReferenceId = centinelResponse.getValue("ReferenceId");
