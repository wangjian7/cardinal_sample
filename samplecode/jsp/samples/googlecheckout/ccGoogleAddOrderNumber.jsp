...
<br/>
<b>Google Checkout Add Order Number Form</b>
<form name="frm" method="POST" action="ccGoogleAddOrderNumber.jsp?execute=true">
<table>
<tr >
	<td bgcolor="ffff40">OrderId </td><td><input type=text size="60" name="order_id" value=""></td>
</tr>
<tr>
	<td bgcolor="ffff40">OrderNumber </td><td><input type=text name="order_number" value=""></td>
</tr>
<tr>
  <td></td>
...
<%
	...
	if (executeTransaction) {
		...
		centinelRequest.add("MsgType", "cmpi_google_add_order_number");
...
<b>Add Merchant Order Number Transaction Request Results </b>
<table>
	<tr>
...
<br/><br/>
<b>Add Merchant Order Number Transaction Results </b>
<table>
	<tr>
