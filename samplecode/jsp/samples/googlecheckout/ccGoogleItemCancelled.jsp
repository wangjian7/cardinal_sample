...
<br/>
<b>Google Item Cancel Form</b>
<form name="frm" method="POST" action="ccGoogleItemCancelled.jsp?execute=true">
<table>
      <tr>
	  ...
	  <tr>
        ...
        <td><input type=text size="60" name="reason_1" value="Wrong Item"></td>
      </tr>
	  <tr>
        <td>Item 2 SKU </td>
...
if ("true".equals(executeTransaction)){
	...
	centinelRequest.add("MsgType", "cmpi_item_cancelled");
	...
	centinelRequest.add("Item_Reason_1", request.getParameter("Item_Reason_1"));
	...
	<b>Google Item Cancel Request </b>
	<table>
	<tr>
	...
	<br/><br/>
	<b>Google Item Cancel Results </b>
    <table>
	<tr>
