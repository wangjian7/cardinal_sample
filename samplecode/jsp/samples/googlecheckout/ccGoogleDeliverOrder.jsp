...
<br/>
<b>Deliver Order Message Form</b>
<form name="frm" method="POST" action="ccGoogleDeliverOrder.jsp?execute=true">
<table>
<tr>
...
<tr>
	<td bgcolor="ffff40">Send Email to Consumer</td>
	<td>
...
<tr>
  <td></td>
  <td><input type=submit name="submit" value="Deliver Order"></td>
</tr>
<tr>
...
<%
	...
	if (executeTransaction) {
		...
		centinelRequest.add("MsgType", "cmpi_google_deliver_order");
...
<b> Deliver Order Message Request Results </b>
<table>
	<tr>
...
<br/><br/>
<b> Deliver Order Message Results </b>
<table>
	<tr>
