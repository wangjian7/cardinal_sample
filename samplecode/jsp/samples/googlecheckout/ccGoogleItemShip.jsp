...
<br/>
<b>Google Item Ship Form</b>
<form name="frm" method="POST" action="ccGoogleItemShip.jsp?execute=true">
<table>
      <tr>
      ...
      <tr>
        <td bgcolor="ffff40">Tracking Number</td>
        <td><input type=text name="Item_Tracking_1" value=""></td>
      </tr>
	  <tr>
        <td>Item 2 SKU </td>
...
if ("true".equals(executeTransaction)){
	...
	centinelRequest.add("Item_Carrier_1", request.getParameter("Item_Carrier_1"));
	centinelRequest.add("Item_Tracking_1", request.getParameter("Item_Tracking_1"));

	// Loop over items that need shipped
	...
	<b> Google Checkout Ship Item Request </b>
	<table>
	<tr>
	...
	<br/><br/>
	<b> Google Checkout Ship Item Results </b>
    <table>
	<tr>
