...
<br/>
<b>Google Item Returned Form</b>
<form name="frm" method="POST" action="ccGoogleItemReturned.jsp?execute=true">
<table>
      <tr>
...
if ("true".equals(executeTransaction)){
	...
	centinelRequest.add("MsgType", "cmpi_item_returned");
	...
	<b>Google Item Returned Request </b>
	<table>
	<tr>
	...
	<br/><br/>
	<b>Google Item Returned Results </b>
    <table>
	<tr>
