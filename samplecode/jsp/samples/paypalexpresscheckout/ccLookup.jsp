...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	centinelRequest.add("TransactionAction", request.getParameter("payment_action"));
	centinelRequest.add("NoShipping", request.getParameter("no_shipping"));
	centinelRequest.add("OverrideAddress", request.getParameter("override_address"));
	centinelRequest.add("ForceAddress", request.getParameter("force_address"));


	//centinelRequest.add("OverrideCallbackURL", "http://centineldev.cardinalcommerce.com/paypal/callback/callback_pp.aspx");
	//centinelRequest.add("OverrideCallbackTimeout", "1");
	//centinelRequest.add("OverrideShippingXML", "<ShippingMethods><ShippingMethod><Name>Standard</Name><Label>Standard Shipping</Label><Amount>0.00</Amount><CurrencyCode>USD</CurrencyCode><Default>true</Default></ShippingMethod><ShippingMethod><Name>2Day</Name><Label>Two Day Air</Label><Amount>3.00</Amount><CurrencyCode>USD</CurrencyCode><Default>false</Default></ShippingMethod><ShippingMethod><Name>NextDay</Name> <Label>Next Day Air</Label><Amount>4.00</Amount><CurrencyCode>USD</CurrencyCode><Default>false</Default></ShippingMethod></ShippingMethods>");
	//centinelRequest.add("MerchantProcessorAlias", "alias");
...
//////////////////////////////////////////////////////////////////////////////////////////
	...
	//centinelResponse = centinelRequest.sendProxyHTTP(TRANSACTION_URL, TIMEOUT_CONNECT, TIMEOUT_READ, "proxy.wdf.sap.corp", 8080, "","");
