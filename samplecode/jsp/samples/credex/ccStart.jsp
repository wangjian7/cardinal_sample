	...
	<td>&nbsp;</td><td></td>
					...
					<td>
						<select name="testCase" onChange="setTestCaseData(document.forms[0].testCase.options[document.forms[0].testCase.selectedIndex].value);">
							<option value=""></option>
							<option value="1">Test Case 1 John Highrisk 2345</option>
							<option value="2">Test Case 2 Cynthia Lowrisk 1234</option>
							<option value="3">Test Case 3 John Test 1234</option>
							<option value="4">Test Case 4 John Lowfico 7094</option>
						</select>
					</td>
					</tr>
<tr>
	<td bgcolor="ffff40">Promo Code</td><td><input type=text name="promo_code" value=""></td>
	<td bgcolor="ffff40">Customer Flag</td>
	<td><select name="customer_flag" id="customer_flag" style="width:125px">
