...
<br/>
<b>POS Cancel Request Form</b>
<form name="frm" method="POST" action="ccPOSCancel.jsp?execute=true">
<table>
<tr>
...
<tr>
	<td bgcolor="ffff40">Message Sub Id</td><td><input type="text" name="msg_sub_id" value=""></td>
</tr>
<tr>
	<td bgcolor="ffff40">Store Id</td><td><input type="text" name="store_id" value="098"></td>
</tr>
<tr>
	<td bgcolor="ffff40">Terminal Id</td><td><input type="text" name="terminal_id" value="023"></td>
</tr>
<tr>
	<td bgcolor="ffff40">Transaction Action</td>
...
<tr>
	<td>Description </td><td><input type=text size="60" name="description" value="Cancel Description"></td>
</tr>
<tr>
  <td></td>
  <td><input type=submit name="submit" value="Process POS Cancel"></td>
</tr>
<tr>
...
<%
	...
	if (executeTransaction) {
		...
		centinelRequest.add("SubMsgType", "cmpi_cancel_pos_transaction");
...
<b> Cancel Transaction Request Results </b>
<table>
<tr>
...
<br/><br/>
<b> Cancel Transaction Results </b>
<table>
<tr>
