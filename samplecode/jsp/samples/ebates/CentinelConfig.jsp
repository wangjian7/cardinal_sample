...
<%
   	...
   	String MESSAGE_VERSION, TRANSACTION_URL, EBATESREDIRECTURL, EBATESORDERCOMPLETE, MERCHANT_ID, PROCESSOR_ID, CENTINEL_TERM_URL, TRANSACTION_PWD;
	int TIMEOUT_CONNECT, TIMEOUT_READ;

	MESSAGE_VERSION  = "1.7";
	TRANSACTION_URL	 = "https://centineltest.cardinalcommerce.com/maps/txns.asp";
	EBATESREDIRECTURL	= "https://centineltest.cardinalcommerce.com/maps/ebates/ebates.asp";
	EBATESORDERCOMPLETE	= "https://centineltest.cardinalcommerce.com/maps/ebates/confirm.asp";
	PROCESSOR_ID	 = "enter value";
	MERCHANT_ID		 = "enter value";
	TRANSACTION_PWD  = "enter value";
	CENTINEL_TERM_URL = "http://yoursite.com/ebates/ccCheckout.jsp";
