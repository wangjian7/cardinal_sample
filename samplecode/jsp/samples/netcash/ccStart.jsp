...
<tr>
	<td>No Shipping</td><td><input type=text name="no_shipping" value=""></td>
	<td>Recurring</td>
...
<tr>
	<td>Recurring Trial Amount</td><td><input type=text name="recurring_trial_amount" value=""></td>
	<td>Recurring Trial Period</td><td><input type=text name="recurring_trial_period" value=""></td>
</tr>
<tr>
	<td>Register Login</td><td><input type=text name="register_login" value=""></td>
	<td>Register Password</td><td><input type=text name="register_password" value=""></td>
</tr>
<tr>
	<td>&nbsp;</td><td></td>
	<td>&nbsp;</td><td></td>
