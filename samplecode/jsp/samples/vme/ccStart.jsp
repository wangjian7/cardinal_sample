...
<tr>
	<td>Override Collect Shipping</td>
	<td><select name="override_collect_shipping">
		  <option value="">
		  <option value="true">true - Collect Shipping</option>
		  <option value="false">false - Do Not Collect Shipping</option>
	</select></td>
	<td></td>
	<td></td>
</tr>
...
<tr>
  <td></td>
  <td><input type="image" src="vmelogo.png" alt="Submit Order"></td>
</tr>
<tr>
