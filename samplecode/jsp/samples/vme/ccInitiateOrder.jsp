...
<html>
<head>
<title>Initiate Order Page</title>
...
<br/>
<b>Initiate Order Request Form</b>
<form name="frm" method="POST" action="ccInitiateOrder.jsp?execute=true">
<table>
<tr>
...
<tr>
	<td bgcolor="ffff40">Payment Processor Order Id</td><td><input type=text name="payment_processor_order_id" value=""></td>
	<td>&nbsp;</td><td></td>
</tr>
<tr>
	<td>&nbsp;</td><td></td>
...
if ("true".equals(executeTransaction)){
	...
	centinelRequest.add("PaymentProcessorOrderId", request.getParameter("payment_processor_order_id"));

	//centinelRequest.add("PaymentWidgetEnabledOverride", "true");
	...
	<b> Initiate Order Transaction Request </b>
	<table>
	<tr>
	...
	<br/><br/>
	<b> Initiate Order Transaction Response </b>
	<table>
	<tr>
