...
<%
	...
	String INITIATE_URL, VME_MERCHANT_ID, VME_SECRETKEY, VME_JS_URL;
	...
	CENTINEL_TERM_URL = "http://yoursite.com/vme/ccAuthenticate.jsp";
	INITIATE_URL     = "http://yoursite.com/vme/ccInitiateOrder.jsp";
	VME_MERCHANT_ID	= "your_vme_merchantid";
	VME_SECRETKEY = "your_vme_secretkey";
	VME_JS_URL = "https://sandbox-static.v.me//js/1/v-widgets.js";
