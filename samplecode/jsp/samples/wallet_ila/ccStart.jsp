...
<script type="text/javascript">
	window.onload = function() {
		var price1 = randomAmount();
		var price2 = randomAmount();

		document.forms["frm"].onsubmit = singleSubmit("frm");
		document.forms["frm"].order_number.value = randomOrderNumber();
		document.forms["frm"].amount.value = parseInt(price1, 10) + parseInt(price2, 10);
		document.forms["frm"].item_price_1.value = price1;
		document.forms["frm"].item_price_2.value = price2;   
	} // end onLoad
</script>
...
%>
<br/>
	<form id="frm" method="post" action="ccLookup.jsp">
		<table>
			<tr>
		   ...
		   <tr>
			...
			<tr>
				<td>NoShipping</td><td><select name="no_shipping" id="no_shipping">
							<option value=""></option>
							<option value="true">true</option>
							<option value="false">false</option>
					</select></td>
				<td>ForceAuthentication</td><td><select name="force_authentication" id="force_authentication">
							<option value=""></option>
							<option value="true">true</option>
							<option value="false">false</option>
					</select></td>
			...
			<tr>
				<td>Rewards Program</td><td><select name="accept_rewards_program" id="accept_rewards_program">
							<option value=""></option>
							<option value="true">true</option>
							<option value="false">false</option>
					</select></td>
				<td>Shipping Location Profile Id</td><td><input type="text" name="shipping_location_profile" value="" /></td>
			</tr>
			<tr>
			...
			<tr>
				<td>Item 1 Image Url </td>
				<td><input type="text" name="item_image_url_1" value="" /></td>
				
				<td>Item 2 Image Url </td>
				<td><input type="text" name="item_image_url_2" value="" /></td>
			</tr>
			<tr>
				<td>&nbsp;</td><td></td>
				<td>&nbsp;</td><td></td>
